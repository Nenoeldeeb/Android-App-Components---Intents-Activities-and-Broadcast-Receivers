...
public class MainActivity extends MainActivityBase {
    ...
    private void setupBroadcastReceiver() {
        ...
        BroadcastReceiver ivb = new ImageViewBroadcastReceiver ();
        ...
        registerReceiver (ivb,intentFilter);
    }
